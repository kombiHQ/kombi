...
Kombi provides an API focused in describing and performing executions (applications, libraries, evaluations...). This project aims to simplify the process of describing nested executions, passing data across the executions, handling options/settings for the executions, dealing with common file system operations, splitting the processing and, providing interoperability across different applications.
