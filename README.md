...
Kombi is focused in processing data across different applications and libraries. Such as image/video processing, ingestion of files, versioning data, (etc). This is done by providing tasks which are used to wrap the execution of applications/libraries in a generic way which you can combine/use the ouput of particular tasks as input of sub tasks and so on. Also, common generic operatations are facilited by Kombi. Such as path manipuation/generation, distributed execution (etc).
