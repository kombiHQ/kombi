...
You can described the specification for the tasks using declarative definitions, speeding up prototyping and simplifying the maintainability by reducing the need for writing boilerplate code.
