...
You may find this project useful in situations where you need to combine serveral different executables/API's. For instance, during image/video processing, ingestion of files, versioning data (etc).
