...
Kombi provides an API to describe and perform executions (applications, libraries, scripts...) by promoting a generic interface focused in simplifying the process of defining nested executions, passing data between executions, handling options/settings for the executions, dealing with common file system operations, splitting the processing and, providing interoperability across different applications.
