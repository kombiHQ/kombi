...
Kombi is focused in describing and performing executions (applications, libraries, evaluations...). It works by providing an API that simplify the process of describing nested executions, passing data across the executions, handling options/settings for the executions, dealing with common file system operations, splitting the processing and, providing interoperability across different applications.
