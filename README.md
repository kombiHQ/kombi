...
Kombi is focused in describing, wrapping and performing executions (applications, evaluations...). It works by providing an API that simplifies the process of describing nested executions, passing data across the executions, handling options/settings for the executions, dealing with path manipulation/file system operations, splitting the processing and, providing interoperability across different applications.
