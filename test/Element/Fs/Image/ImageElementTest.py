...
class ImageElementTest(BaseTestCase):
    ...
    def testSingleImage(self):
        ...
        """
        element = Element.create(PathHolder(self.__singleFile))
    ...
    def testSequenceImage(self):
        ...
        """
        element = Element.create(PathHolder(self.__sequenceFile))
        self.assertIsInstance(element, ImageElement)
    ...
    def testIsSequence(self):
        ...
        """
        singleElement = Element.create(PathHolder(self.__singleFile))
        sequenceElement = Element.create(PathHolder(self.__sequenceFile))
