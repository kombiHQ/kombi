...
class VendorXPlatesInlineCrawlersTest(BaseTestCase):
    """Test for the example vendor 'x' plates using inline crawlers."""

    __exampleDirectory = os.path.join(BaseTestCase.dataDirectory(), 'examples', 'vendorXPlatesInlineCrawlers')
