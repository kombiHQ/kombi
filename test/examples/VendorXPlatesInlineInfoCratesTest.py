...
class VendorXPlatesInlineInfoCratesTest(BaseTestCase):
    """Test for the example vendor 'x' plates using inline infoCrates."""

    __exampleDirectory = os.path.join(BaseTestCase.dataDirectory(), 'examples', 'vendorXPlatesInlineInfoCrates')
