...
class VendorXPlatesInlineElementsTest(BaseTestCase):
    """Test for the example vendor 'x' plates using inline elements."""

    __exampleDirectory = os.path.join(BaseTestCase.dataDirectory(), 'examples', 'vendorXPlatesInlineElements')
