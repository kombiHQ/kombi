...
class NukeRenderCrawler(ExrRenderCrawler):
    """
    ...
    def __init__(self, *args, **kwargs):
        """
        Create a NukeRenderCrawler object.
        """
        super(NukeRenderCrawler, self).__init__(*args, **kwargs)
    ...
    def test(cls, pathHolder, parentCrawler):
        ...
        """
        if not super(NukeRenderCrawler, cls).test(pathHolder, parentCrawler):
            return False
