...
class TextureCrawler(OiioCrawler):
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        super(TextureCrawler, self).__init__(*args, **kwargs)
    ...
    def setVar(self, name, value, *args, **kwargs):
        ...
        super(TextureCrawler, self).setVar(name, value, *args, **kwargs)
