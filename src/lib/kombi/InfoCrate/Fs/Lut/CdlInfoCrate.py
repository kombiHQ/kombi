...
class CdlInfoCrate(LutInfoCrate):
    """
    Parses a cdl file.
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        Create a cdl object.
        """
        super(CdlInfoCrate, self).__init__(*args, **kwargs)
    ...
    def test(cls, pathHolder, parentInfoCrate):
        ...
        """
        if not super(CdlInfoCrate, cls).test(pathHolder, parentInfoCrate, ignoreExt=True):
            return False
    ...
    def __parseXML(self):
        """
        Parse the cld file (XML file format) information and assign that to the infoCrate.
        """
