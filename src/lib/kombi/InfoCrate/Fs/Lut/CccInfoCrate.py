...
class CccInfoCrate(LutInfoCrate):
    """
    Parses a Ccc file.
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        Create a Ccc object.
        """
        super(CccInfoCrate, self).__init__(*args, **kwargs)
    ...
    def test(cls, pathHolder, parentInfoCrate):
        ...
        """
        if not super(CccInfoCrate, cls).test(pathHolder, parentInfoCrate, ignoreExt=True):
            return False
