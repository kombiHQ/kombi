...
class VideoInfoCrate(FileInfoCrate):
    """
    Abstracted video infoCrate.
    """
    ...
    def __init__(self, *args, **kwargs):
        """
        Create a video infoCrate.
        """
        super(VideoInfoCrate, self).__init__(*args, **kwargs)
    ...
    def var(self, name):
        ...
        return super(VideoInfoCrate, self).var(name)

    def __computeWidthHeight(self):
        """
        Query width and height using ffprobe and set them as infoCrate variables.
        """
