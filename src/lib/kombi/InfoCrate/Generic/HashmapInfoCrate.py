...
class HashmapInfoCrate(InfoCrate):
    """
    Hashmap infoCrate to store key/value data.
    """

    def __init__(self, data, parentInfoCrate=None):
        """
        Create a hashmap infoCrate.
        """
        assert isinstance(data, dict), "Invalid dict!"

        super(HashmapInfoCrate, self).__init__("hashmap", parentInfoCrate)
    ...
    def __repr__(self):
        """
        Return a string representation of the infoCrate.
        """
