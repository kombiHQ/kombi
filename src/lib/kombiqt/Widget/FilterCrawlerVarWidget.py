...
class FilterCrawlerVarWidget(QtWidgets.QWidget):
    """
    Filter crawler var widget.
    """
    ...
    def __init__(self):
        """
        Create an filter crawler var widget.
        """
        super(FilterCrawlerVarWidget, self).__init__()
    ...
    def refresh(self, filterVarName, crawlers):
        """
        ...
        for crawler in crawlers:
            if self.__filterVarName not in crawler.varNames():
                continue
            varValues.add(crawler.var(self.__filterVarName))
        ...
        for varName in sorted(varValues):
            ...
            widget.setObjectName('filterCrawlerVar')
    ...
    def filterVarName(self):
        """
        Return the name of the crawler var name used to collect the filters.
        """
