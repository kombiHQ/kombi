...
class FilterInfoCrateVarWidget(QtWidgets.QWidget):
    """
    Filter infoCrate var widget.
    """
    ...
    def __init__(self):
        """
        Create an filter infoCrate var widget.
        """
        super(FilterInfoCrateVarWidget, self).__init__()
    ...
    def refresh(self, filterVarName, infoCrates):
        """
        ...
        for infoCrate in infoCrates:
            if self.__filterVarName not in infoCrate.varNames():
                continue
            varValues.add(infoCrate.var(self.__filterVarName))
        ...
        for varName in sorted(varValues):
            ...
            widget.setObjectName('filterInfoCrateVar')
    ...
    def filterVarName(self):
        """
        Return the name of the infoCrate var name used to collect the filters.
        """
