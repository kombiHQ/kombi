...
class SGPublish(Task):
    ...
    __shotgunUrl = os.environ.get('CHILOPODA_SHOTGUN_URL', '')
    __shotgunScriptName = os.environ.get('CHILOPODA_SHOTGUN_SCRIPTNAME', '')
    __shotgunApiKey = os.environ.get('CHILOPODA_SHOTGUN_APIKEY', '')
    ...
    def __sgUser(self, sg):
        ...
        user = os.environ.get("CHILOPODA_USER", getpass.getuser()),
