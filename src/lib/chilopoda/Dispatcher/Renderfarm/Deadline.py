...
class Deadline(Renderfarm):
    ...
    __defaultGroup = os.environ.get('CHILOPODA_DISPATCHER_RENDERFARM_GROUP', '')
    __defaultPool = os.environ.get('CHILOPODA_DISPATCHER_RENDERFARM_POOL', '')
    __defaultSecondaryPool = os.environ.get('CHILOPODA_DISPATCHER_RENDERFARM_SECONDARYPOOL', '')
