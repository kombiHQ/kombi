...
class FilePathOptionVisual(OptionVisual):
    ...
    def __buildWidget(self):
        ...
        filePicker = QtWidgets.QPushButton(self.uiHints().get('buttonLabel', 'Select file'))
...
OptionVisual.registerExample('filePath', 'buttonLabel', '/file/path', {'buttonLabel': 'Custom button label'})
